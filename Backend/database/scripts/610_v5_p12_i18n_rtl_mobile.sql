...
('de', 'v5.p11p12', 'notifyCta', 'Benachrichtigung mit hoher PrioritÃ¤t senden'),
('de', 'v5.p11p12', 'language', 'Sprache'),
('de', 'v5.p11p12', 'mobileProof', 'Mobiler Nachweis fÃ¼r PrÃ¼fen und Handeln'),

('ar', 'v5.p11p12', 'title', 'Ø§Ù„Ø¥Ø´Ø¹Ø§Ø±Ø§Øª Ø§Ù„Ø®Ø§Ø±Ø¬ÙŠØ© + Ø§Ù„ØªØ¯ÙˆÙŠÙ„'),
('ar', 'v5.p11p12', 'leadCta', 'ØªØ³Ø¬ÙŠÙ„ Ø¹Ù…ÙŠÙ„ ØªØ¬Ø±ÙŠØ¨ÙŠ'),
('ar', 'v5.p11p12', 'notifyCta', 'Ø¥Ø±Ø³Ø§Ù„ ØªÙ†Ø¨ÙŠÙ‡ Ø¹Ø§Ù„ÙŠ Ø§Ù„Ø®Ø·ÙˆØ±Ø©'),
('ar', 'v5.p11p12', 'language', 'Ø§Ù„Ù„ØºØ©'),
('ar', 'v5.p11p12', 'mobileProof', 'Ø¥Ø«Ø¨Ø§Øª Ø§Ù„Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø¹Ù„Ù‰ Ø§Ù„Ù‡Ø§ØªÙ ÙˆØ§Ù„ØªØ§Ø¨Ù„Øª')
