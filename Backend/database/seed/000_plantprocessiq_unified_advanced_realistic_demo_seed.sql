-- ============================================================================
-- PlantProcess IQ - Unified Advanced Realistic Demo Seed
-- File: database/seeds/000_plantprocessiq_unified_advanced_realistic_demo_seed.sql
-- Generated: 2026-05-11
-- Purpose:
--   Single professional seed file that merges:
--     001_basic_genealogy_seed.sql
--     002_full_feature_demo_seed.sql
--     003_additional_demo_seed.sql
--
-- Design Rules:
--   1. This is database-only demo data. No demo data should be hard-coded in API/Application code.
--   2. Steel, aluminum, pharma, tire and other industry words are demo metadata only.
--      They must stay configurable through IndustryTemplate, OperationDefinition, Route,
--      MaterialUnitTypeDefinition, ParameterDefinition and DefectCatalog.
--   3. The file is idempotent for local development: every INSERT uses ON CONFLICT DO NOTHING.
--   4. Intentional bad-data records are included to test validation/data-quality behavior.
--   5. Run this only after EF migrations are applied, including:
--        - AddStagingRecordEntity
--        - AddPhaseGCorrelationResults
--
-- Recommended execution:
--   psql -h localhost -p 5432 -U plantprocess -d plantprocessiq --        -f database/seeds/000_plantprocessiq_unified_advanced_realistic_demo_seed.sql
--
-- Coverage:
--   - Plant layout: multi-site, areas, equipment hierarchy.
--   - Configuration: templates, material unit types, operations, routes, route steps.
--   - Integration: source systems, import batches, mapping definitions.
--   - Materials: units, aliases, genealogy from raw/intermediate/final material.
--   - Process: steps, observations, process events, downtime events.
--   - Quality: defect catalog, quality events, intentional validation defects.
--   - Analytics: risk scores and contributor JSON for low/medium/high risk cases.
--   - Phase F realism: second site, aluminum route, deep 5-level genealogy,
--     aborted process step, boolean parameter observation.
-- ============================================================================
...
DO $$
BEGIN
    RAISE NOTICE 'Starting PlantProcess IQ unified advanced realistic demo seed...';
END $$;


-- ============================================================================
-- A. Basic Genealogy Smoke Seed
-- Source file merged from: 001_basic_genealogy_seed.sql
-- ============================================================================
...
-- ============================================================================
-- B. Advanced Full Feature Demo Seed
-- Source file merged from: 002_full_feature_demo_seed.sql
-- ============================================================================
...
VALUES
-- Flat steel chain A
('13000000-0000-0000-0000-000000000001', NOW(), NULL, TRUE, 'MES_ADV_DEMO', 'ALIAS-H1001', FALSE, NULL, NULL, '12000000-0000-0000-0000-000000000001', 'MES_HEAT_ADV_H8001', 'HeatId'),
('13000000-0000-0000-0000-000000000002', NOW(), NULL, TRUE, 'MES_ADV_DEMO', 'ALIAS-C2001', FALSE, NULL, NULL, '12000000-0000-0000-0000-000000000002', 'MES_CAST_ADV_C8002', 'CastId'),
...
('13000000-0000-0000-0000-000000000004', NOW(), NULL, TRUE, 'QMS_ADV_DEMO', 'ALIAS-COIL4001', FALSE, NULL, NULL, '12000000-0000-0000-0000-000000000004', 'QMS_COIL_ADV_8004', 'CoilId'),
...
-- Pharma
('13000000-0000-0000-0000-000000000101', NOW(), NULL, TRUE, 'MES_ADV_DEMO', 'ALIAS-PH-BATCH', FALSE, NULL, NULL, '12000000-0000-0000-0000-000000000101', 'MES_PH_BATCH_8101', 'BatchId'),
('13000000-0000-0000-0000-000000000102', NOW(), NULL, TRUE, 'MES_ADV_DEMO', 'ALIAS-PH-LOT', FALSE, NULL, NULL, '12000000-0000-0000-0000-000000000102', 'MES_PH_LOT_8102', 'LotId'),
('13000000-0000-0000-0000-000000000103', NOW(), NULL, TRUE, 'QMS_ADV_DEMO', 'ALIAS-PH-PACK', FALSE, NULL, NULL, '12000000-0000-0000-0000-000000000103', 'QMS_PH_PACK_8103', 'PackagedLotId'),

-- Tire
('13000000-0000-0000-0000-000000000201', NOW(), NULL, TRUE, 'MES_ADV_DEMO', 'ALIAS-TI-COMP', FALSE, NULL, NULL, '12000000-0000-0000-0000-000000000201', 'MES_TIRE_COMPOUND_8201', 'CompoundBatchId'),
('13000000-0000-0000-0000-000000000202', NOW(), NULL, TRUE, 'QMS_ADV_DEMO', 'ALIAS-TI-UNIT', FALSE, NULL, NULL, '12000000-0000-0000-0000-000000000202', 'QMS_TIRE_UNIT_8202', 'TireUnitId')
ON CONFLICT DO NOTHING;
...
-- ============================================================================
-- C. Phase F Multi-Site / Aluminum / Deep Genealogy Extension
-- Source file merged from: 003_additional_demo_seed.sql
-- ============================================================================
...
-- ============================================================================
-- Final Demo Dataset Sanity Summary
-- ============================================================================

DO $$
BEGIN
    RAISE NOTICE 'PlantProcess IQ unified seed finished. Review the summary SELECT results below.';
END $$;

SELECT 'source_system_definitions' AS table_name, COUNT(*) AS row_count FROM source_system_definitions
UNION ALL SELECT 'sites', COUNT(*) FROM sites
UNION ALL SELECT 'areas', COUNT(*) FROM areas
UNION ALL SELECT 'equipment', COUNT(*) FROM equipment
UNION ALL SELECT 'industry_templates', COUNT(*) FROM industry_templates
UNION ALL SELECT 'material_unit_type_definitions', COUNT(*) FROM material_unit_type_definitions
UNION ALL SELECT 'operation_definitions', COUNT(*) FROM operation_definitions
UNION ALL SELECT 'routes', COUNT(*) FROM routes
UNION ALL SELECT 'route_steps', COUNT(*) FROM route_steps
UNION ALL SELECT 'import_batches', COUNT(*) FROM import_batches
UNION ALL SELECT 'mapping_definitions', COUNT(*) FROM mapping_definitions
UNION ALL SELECT 'staging_records', COUNT(*) FROM staging_records
UNION ALL SELECT 'material_units', COUNT(*) FROM material_units
UNION ALL SELECT 'material_aliases', COUNT(*) FROM material_aliases
UNION ALL SELECT 'genealogy_edges', COUNT(*) FROM genealogy_edges
UNION ALL SELECT 'process_step_executions', COUNT(*) FROM process_step_executions
UNION ALL SELECT 'parameter_definitions', COUNT(*) FROM parameter_definitions
UNION ALL SELECT 'parameter_observations', COUNT(*) FROM parameter_observations
UNION ALL SELECT 'process_events', COUNT(*) FROM process_events
UNION ALL SELECT 'downtime_events', COUNT(*) FROM downtime_events
UNION ALL SELECT 'defect_catalogs', COUNT(*) FROM defect_catalogs
...
--   - Some rows are intentionally imperfect to validate /validation/sync-report and /data-quality/scan/run.
--   - At least one high-risk score intentionally has no contributor JSON.
--   - One invalid risk score > 1 exists only as a direct SQL validation test row.
--   - Some process/downtime/event rows are intentionally missing references.
