    ...
    <main className="page-shell phase7-value-scenario" data-testid="phase7-value-scenario-page">
      <section className="dashboard-hero">
        ...
        <div className="phase7-value-actions">
          <StandardP2Button className="phase7-value-button" type="button" onClick={runScenario} disabled={isRunning}>
            {isRunning ? "Running..." : "Run value scenario"}
          </StandardP2Button>
          <StandardP2Button className="phase7-value-button" type="button" onClick={recordTrackedValue} disabled={isRunning || !realization}>
