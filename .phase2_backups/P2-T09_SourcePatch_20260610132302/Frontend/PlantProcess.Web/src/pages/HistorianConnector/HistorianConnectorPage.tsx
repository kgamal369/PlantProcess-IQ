  ...
  return (
    <main data-testid="historian-connector-page">
      ...
      <section>
        ...
        <div>
          <StandardP2Button type="button" disabled={busy} onClick={testConnection}>Test connection</StandardP2Button>
          <StandardP2Button type="button" disabled={busy} onClick={browseTags}>Browse tags</StandardP2Button>
          <StandardP2Button type="button" disabled={busy} onClick={readWindow}>Read sample window</StandardP2Button>
          <StandardP2Button type="button" disabled={busy} onClick={createMappingHints}>Create mapping hints</StandardP2Button>
        </div>
        {provider ? (
          <p>
