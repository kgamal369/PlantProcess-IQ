  ...
  return (
    <main className="phase8-page" data-testid="phase8-assistant-configuration-page">
      ...
      <section className="phase8-card">
        ...
        <div>
          <StandardP2Button className="phase8-button" type="button" disabled={busy} onClick={() => void save()}>Save configuration</StandardP2Button>
          <StandardP2Button className="phase8-button" type="button" disabled={busy} onClick={() => void reset()}>Reset safe defaults</StandardP2Button>
        </div>
