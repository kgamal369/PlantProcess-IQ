    ...
    <main className="phase8-page" data-testid="phase8-suggestion-recommendation-page">
      ...
      <section className="phase8-two-col">
        <div className="phase8-card">
          ...
          <StandardP2Button className="phase8-button" type="button" disabled={busy} onClick={() => void generate()}>
          ...
          <div className="phase8-grid">
            {response.recommendations.map((item) => (
              <article className="phase8-card" key={item.recommendationId}>
                ...
                <div>
                  <StandardP2Button className="phase8-button" type="button" disabled={busy} onClick={() => void decide(item, "approve")}>Approve for review</StandardP2Button>
                  <StandardP2Button className="phase8-button" type="button" disabled={busy} onClick={() => void decide(item, "dismiss")}>Dismiss</StandardP2Button>
                </div>
              </article>
            ))}
          </div>
