    ...
    <main data-testid="phase15-benchmarking-page">
      ...
      <section>
        <div>
          ...
          <div>
            <StandardP2Button type="button" disabled={busy} onClick={() => void refresh()}>Refresh benchmark</StandardP2Button>
            <StandardP2Button type="button" disabled={busy} onClick={() => void loadSuppressedDemo()}>Demo suppressed benchmark</StandardP2Button>
          </div>
        </div>
