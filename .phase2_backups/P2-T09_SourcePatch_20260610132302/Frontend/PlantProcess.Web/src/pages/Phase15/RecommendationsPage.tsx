...
import { P2T08_STANDARD_ROLLOUT_MARKER, StandardP2Button, StandardP2Table } from "@/components/standard/StandardP2Controls";
import {
  phase15AdvisoryApi,
  ...
  return (
    <main data-testid="phase15-recommendations-page">
      ...
      <section>
        ...
        <div>
          <StandardP2Button type="button" disabled={busy || !request} onClick={generate}>Generate recommendation</StandardP2Button>
            ...
            <div>
              {response.recommendations.map((recommendation) => (
                <div key={recommendation.recommendationId}>
                  ...
                  <div>
                    <StandardP2Button type="button" disabled={busy} onClick={() => void decide(recommendation, 1)}>Approve for review</StandardP2Button>
                    <StandardP2Button type="button" disabled={busy} onClick={() => void decide(recommendation, 2)}>Dismiss</StandardP2Button>
                  </div>
                </div>
              ))}
            </div>
