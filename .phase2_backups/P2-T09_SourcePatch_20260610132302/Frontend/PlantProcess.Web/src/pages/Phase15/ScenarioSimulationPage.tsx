        ...
        <div>
          ...
          {request ? (
            <>
              ...
              <div>
                <StandardP2Button type="button" disabled={busy} onClick={simulate}>Run what-if simulation</StandardP2Button>
                <StandardP2Button type="button" disabled={busy} onClick={makeOutOfEnvelope}>Demo out-of-envelope abstain</StandardP2Button>
                <StandardP2Button type="button" disabled={busy} onClick={() => void refresh()}>Reload sample</StandardP2Button>
              </div>
            </>
