    ...
    <main className="value-exec-page" data-p3-task="P3-T14" data-testid="p3-t14-value-executive-dashboard">
      <section className="value-exec-hero">
        ...
        <div className="value-exec-actions">
          <StandardP2Button className="value-exec-button" type="button" onClick={runDashboard} disabled={isRunning}>
            {isRunning ? "Running..." : "Run approved finding through value engine"}
          </StandardP2Button>
          <StandardP2Button className="value-exec-button warning" type="button" onClick={runAbstain} disabled={isRunning}>
            Prove ABSTAIN on missing assumptions
          </StandardP2Button>
          <StandardP2Button className="value-exec-button secondary" type="button" onClick={printReport} disabled={!impact || impact.isAbstained}>
