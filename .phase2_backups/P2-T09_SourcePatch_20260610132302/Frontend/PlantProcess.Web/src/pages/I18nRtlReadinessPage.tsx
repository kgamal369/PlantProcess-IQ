    ...
    <main className="phase78-readiness-page" id="main-content">
      <section className="phase78-readiness-hero">
        ...
        <div className="phase78-readiness-actions" aria-label={t("toggleLanguage", locale)}>
          <StandardP2Button type="button" onClick={() => setLocale("en")}>{t("english", locale)}</StandardP2Button>
          <StandardP2Button type="button" onClick={() => setLocale("ar")}>{t("arabic", locale)}</StandardP2Button>
        </div>
      </section>
