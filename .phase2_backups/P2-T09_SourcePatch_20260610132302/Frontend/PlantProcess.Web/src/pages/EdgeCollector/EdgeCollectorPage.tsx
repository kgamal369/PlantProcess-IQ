...
import { P2T08_STANDARD_ROLLOUT_MARKER, StandardP2Button, StandardP2Input, StandardP2Table } from "@/components/standard/StandardP2Controls";
import {
  edgeCollectorApi,
  ...
  return (
    <main data-testid="edge-collector-page">
      ...
      <section>
        ...
        <div>
          <StandardP2Button type="button" disabled={busy} onClick={registerCollector}>Register collector</StandardP2Button>
          <StandardP2Button type="button" disabled={busy} onClick={sendHeartbeat}>Send heartbeat</StandardP2Button>
          <StandardP2Button type="button" disabled={busy} onClick={sendQueueStatus}>Update queue status</StandardP2Button>
          <StandardP2Button type="button" disabled={busy} onClick={pushSampleBatch}>Push sample batch</StandardP2Button>
          <StandardP2Button type="button" disabled={busy} onClick={() => void refresh()}>Refresh status</StandardP2Button>
        </div>
      </section>
