...
Run-Checked "Pack P3A T016-T022 validation" "node .\tools\v5\validate-pack-p3-t016-t022.mjs" $RepoRoot
...
Write-Host ""
Write-Host "Pack P3A T016-T022 validation passed." -ForegroundColor Green
Write-Host "Report:" -ForegroundColor Yellow
Write-Host "  Documentation\v5\pack-p3-t016-t022-validation-report.json" -ForegroundColor Yellow