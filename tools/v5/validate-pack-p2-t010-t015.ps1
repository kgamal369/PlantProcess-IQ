...
Run-Checked "Pack P2A T010-T015 validation" "node .\tools\v5\validate-pack-p2-t010-t015.mjs" $RepoRoot
...
Write-Host ""
Write-Host "Pack P2A T010-T015 validation passed." -ForegroundColor Green
Write-Host "Report:" -ForegroundColor Yellow
Write-Host "  Documentation\v5\pack-p2-t010-t015-validation-report.json" -ForegroundColor Yellow