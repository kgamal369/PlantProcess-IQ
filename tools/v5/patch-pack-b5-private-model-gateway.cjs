...
addUsing("using PlantProcess.Api.AssistantGateway;");
addMap("app.MapV5PrivateModelGatewayCertificationEndpoints();");

fs.writeFileSync(file, text, "utf8");
console.log("[pack-b5] Program.cs patched for private model gateway certification endpoints.");