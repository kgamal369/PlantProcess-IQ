...
addUsing("using PlantProcess.Api.DeploymentPortability;");
addUsing("using PlantProcess.Api.ComplianceControls;");

addMap("app.MapV5DeploymentPortabilityEndpoints();");
addMap("app.MapV5ComplianceControlsEndpoints();");

fs.writeFileSync(file, text, "utf8");

console.log("[p13-p14] Program.cs patched");