...
addUsing("using PlantProcess.Api.VisualMapper;");
addUsing("using PlantProcess.Api.BlendedProvenance;");
...
addMap("app.MapV5VisualMapperEndpoints();");
addMap("app.MapV5BlendedProvenanceEndpoints();");

fs.writeFileSync(full, text, "utf8");
console.log(`[p05-p06] patched ${rel}`);