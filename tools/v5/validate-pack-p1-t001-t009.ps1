...
Run-Checked "Pack P1A T001-T009 validation" "node .\tools\v5\validate-pack-p1-t001-t009.mjs" $RepoRoot
...
Write-Host ""
Write-Host "Pack P1A T001-T009 validation passed." -ForegroundColor Green
Write-Host "Report:" -ForegroundColor Yellow
Write-Host "  Documentation\v5\pack-p1-t001-t009-validation-report.json" -ForegroundColor Yellow