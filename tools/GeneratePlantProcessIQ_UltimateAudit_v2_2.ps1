...
<#
.SYNOPSIS
    PlantProcess IQ Ultimate Documentation + Deep AI Audit Generator (v2.2).
...
function Get-FileClassification {
    ...
    if ($name -in @("uv.lock", "poetry.lock", "Pipfile.lock")) { return "Python Dependency Lock" }
...
Write-Step "============================================================"
Write-Step " PlantProcess IQ Ultimate Documentation + Deep Audit (v2.2)"
Write-Step "============================================================"
