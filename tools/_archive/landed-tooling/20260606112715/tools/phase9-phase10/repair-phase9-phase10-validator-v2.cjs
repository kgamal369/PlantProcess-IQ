...
const backupRoot = path.join(root, ".phase9_phase10_backup", "validator_repair_v2_" + timestamp);
...
console.log("=================================================================================================");
console.log("PlantProcess IQ Phase 9/10 validator repair v2");
console.log("=================================================================================================");
...
run("node --check repaired Phase 9/10 validator v2", ["node", "--check", "tools/phase9-phase10/validate-phase9-phase10.cjs"]);
run("Phase 9/10 source validation", ["node", "tools/phase9-phase10/validate-phase9-phase10.cjs"]);

console.log("");
console.log("=================================================================================================");
console.log("Phase 9/10 validator repair v2 completed successfully.");
