...
// ============================================================================
// SQL 205 — Phase 4/5 completion governance, jobs, monitor, providers, tests
// ============================================================================

write("Backend/database/scripts/205_phase04_phase05_completion_governance_jobs_tests.sql", String.raw`
-- ============================================================================
-- PlantProcess IQ
...
// ============================================================================
// C# provider abstraction files
// ============================================================================

write("Backend/PlantProcess.Application/Analytics/Contracts/NarrativeProviderDtos.cs", String.raw`
...
write("Backend/PlantProcess.Application/Analytics/Interfaces/INarrativeProvider.cs", String.raw`
...
write("Backend/PlantProcess.Application/Analytics/Services/LocalNarrativeProvider.cs", String.raw`
...
write("Backend/PlantProcess.Application/Analytics/Services/ApiNarrativeProvider.cs", String.raw`
...
write("Backend/PlantProcess.Application/Analytics/Services/ConfiguredNarrativeProvider.cs", String.raw`
using Microsoft.Extensions.Configuration;
using PlantProcess.Application.Analytics.Contracts;
using PlantProcess.Application.Analytics.Interfaces;
...
// ============================================================================
// Provider proof API endpoint
// ============================================================================

write("Backend/PlantProcess.Api/Endpoints/Analytics/MlProviderEndpoints.cs", String.raw`
using PlantProcess.Application.Analytics.Contracts;
using PlantProcess.Application.Analytics.Interfaces;
...
patch("Backend/PlantProcess.Application/DependencyInjection.cs", (text) => {
  let next = text;

  if (!next.includes("LocalNarrativeProvider")) {
    next = next.replace(
...
// ============================================================================
// Program.cs route patch
// ============================================================================

patch("Backend/PlantProcess.Api/Program.cs", (text) => {
  let next = text;

  if (!next.includes("MapMlProviderEndpoints")) {
    const marker = "app.MapMlLearningEndpoints();";

    if (next.includes(marker)) {
      next = next.replace(marker, marker + "\napp.MapMlProviderEndpoints();");
    } else if (next.includes("app.MapMlFoundationEndpoints();")) {
      next = next.replace("app.MapMlFoundationEndpoints();", "app.MapMlFoundationEndpoints();\napp.MapMlProviderEndpoints();");
    } else {
      throw new Error("Could not find analytics route mapping point for MlProviderEndpoints.");
    }
  }
...
write("tools/validation/validate-v7-phase04-phase05-completion.cjs", String.raw`
const fs = require("node:fs");
...
console.log("");
console.log("PPIQ V7 Phase 4/5 completion pack applied.");
console.log("");
console.log("Next:");
console.log("  node .\\tools\\validation\\validate-v7-phase04-phase05-completion.cjs");
console.log("  psql -f Backend\\database\\scripts\\205_phase04_phase05_completion_governance_jobs_tests.sql");
