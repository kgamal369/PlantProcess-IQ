...
const replacements = [
  ...
  // Any accidental remaining invalid path fragments in string literals
...
// Final scan for invalid product-module identifiers.
...
const report = {
  ...
  importOffenders,
  contentFindings,
  note: "Invalid identifier offenders, path offenders, and import offenders must be zero. Content findings are allowed for C4."
};
...
console.log("[pack-c2-hotfix02] invalid product-module identifiers fixed.");