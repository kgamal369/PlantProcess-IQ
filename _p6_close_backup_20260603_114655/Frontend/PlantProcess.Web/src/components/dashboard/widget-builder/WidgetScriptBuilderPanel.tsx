      ...
      <StandardCard
        ...
        actions={
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            <StandardButton variant="ghost" type="button" onClick={onValidate} disabled={busy !== null}>
              {busy === "validate" ? "Validating..." : "Validate"}
            </StandardButton>
            <StandardButton variant="ghost" type="button" onClick={onPreview} disabled={busy !== null}>
              {busy === "preview" ? "Previewing..." : "Preview"}
            </StandardButton>
            <StandardButton variant="primary" type="button" onClick={onPublishClick} disabled={!validated || busy !== null}
