...
- Name: route-smoke.spec.ts >> PlantProcess IQ route smoke regression >> opens /admin without browser errors
...
Timeout: 15000ms
Expected pattern: /admin|jobs|configuration|plantprocess iq/i
Received string:  "·············
"
