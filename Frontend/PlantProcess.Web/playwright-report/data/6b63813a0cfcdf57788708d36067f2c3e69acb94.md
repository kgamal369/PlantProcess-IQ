...
- Name: admin-db-focused.spec.ts >> FE-HARD-016 — AdminDbConfigurationTab focused QA >> admin DB configuration loads safely and exposes DB configuration workflow
- Location: e2e\admin-db-focused.spec.ts:20:3
