...
- Name: admin-db-focused.spec.ts >> FE-HARD-016 — AdminDbConfigurationTab focused QA >> admin DB configuration shows controlled state when backend fails
- Location: e2e\admin-db-focused.spec.ts:69:3
