...
- Name: hardening-matrix.spec.ts >> QA-HARD-001 — per-page hardening matrix >> Material Investigation should survive simulated backend outage
- Location: e2e\hardening-matrix.spec.ts:105:5
