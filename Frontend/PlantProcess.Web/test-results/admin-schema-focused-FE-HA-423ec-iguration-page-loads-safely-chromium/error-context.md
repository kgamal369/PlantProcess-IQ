...
- Name: admin-schema-focused.spec.ts >> FE-HARD-017 — AdminSchemaConfigurationTab focused QA >> schema configuration page loads safely
- Location: e2e\admin-schema-focused.spec.ts:21:3
