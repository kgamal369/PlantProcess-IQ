...
- Name: hardening-matrix.spec.ts >> QA-HARD-001 — per-page hardening matrix >> Material Investigation direct route should render safely
- Location: e2e\hardening-matrix.spec.ts:82:5
