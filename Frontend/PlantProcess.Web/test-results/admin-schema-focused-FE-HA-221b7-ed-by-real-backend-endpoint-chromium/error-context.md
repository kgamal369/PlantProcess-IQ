...
- Name: admin-schema-focused.spec.ts >> FE-HARD-017 — AdminSchemaConfigurationTab focused QA >> unsafe ad-hoc SQL preview is blocked by real backend endpoint
- Location: e2e\admin-schema-focused.spec.ts:35:3
