...
- Name: phase2-navigation-refresh-survival.spec.ts >> PPIQ-HARD-031 — navigation and browser refresh survival >> Demo Lifecycle should load directly and survive refresh
