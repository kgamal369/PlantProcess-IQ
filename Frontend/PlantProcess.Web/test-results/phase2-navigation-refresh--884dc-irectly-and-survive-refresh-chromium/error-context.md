...
- Name: phase2-navigation-refresh-survival.spec.ts >> PPIQ-HARD-031 — navigation and browser refresh survival >> Dashboard should load directly and survive refresh
