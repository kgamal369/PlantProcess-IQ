...
- Name: license-and-demo-lifecycle.spec.ts >> PlantProcess IQ license gates and demo lifecycle >> license current endpoint returns tier, limits and features
- Location: e2e\license-and-demo-lifecycle.spec.ts:5:3
