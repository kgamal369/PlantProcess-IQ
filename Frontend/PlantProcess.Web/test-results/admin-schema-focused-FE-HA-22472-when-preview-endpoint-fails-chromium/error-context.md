...
- Name: admin-schema-focused.spec.ts >> FE-HARD-017 — AdminSchemaConfigurationTab focused QA >> schema page stays customer-safe when preview endpoint fails
- Location: e2e\admin-schema-focused.spec.ts:61:3
