...
assertContains("P10-02 pricing/security", app, [
  "Light â†’ Pro â†’ Pro Plus â†’ Enterprise",
...
assertContains("P10/P11 lead capture", requestForm, [
...
if (/localStorage\.(setItem|getItem|removeItem)\([^)]*(lead|demoLead|demoLeads|ppiq\.website\.demoLeads)/i.test(requestForm)) {
  throw new Error("Backend lead capture no browser lead persistence failed: RequestDemoForm still uses localStorage for leads.");
}
console.log("✓ Backend lead capture no browser lead persistence");