...
assertContains("P12 Arabic locale code", p12Sql, "'ar'");
assertContains("P12 RTL direction", p12Sql, "'rtl'");
...
assertContains("P12 Arabic catalog", i18n, "Ø§Ù„Ø¥Ø´Ø¹Ø§Ø±Ø§Øª Ø§Ù„Ø®Ø§Ø±Ø¬ÙŠØ©");
...
console.log("âœ“ P11 website lead storage: no localStorage lead persistence detected");
