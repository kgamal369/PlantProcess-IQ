...
Product-generic files scanned: 1070
Grandfathered fingerprints: 91
...
## Backend/PlantProcess.Application/Dashboarding/Contracts/DashboardDtos.cs  (3)

- [UA-08] L80 `string? productfamily,`  fp=d735213d3e31
- [UA-08] L81 `string? gradeorrecipe,`  fp=ecd44f854e22
- [UA-08] L165 `string? riskclass,`  fp=7e2cf97cfd69
...
- [UA-08] L5912 `("riskclass",`  fp=9bde0138c610
- [UA-08] L6280 `("gradeorrecipe",`  fp=5b5dcf06f0bd
...
## Frontend/PlantProcess.Web/src/components/dashboard/SavedDashboardWidget.tsx  (1)

- [UA-08] L291 `["gradeorrecipe",`  fp=b001c43f201a
