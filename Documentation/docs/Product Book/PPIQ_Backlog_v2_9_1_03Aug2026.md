...
**Version 2.9.1 - 3 August 2026**  
**Supersedes:** v2.9  
**Trigger:** Review of v2.9 against Chapter 3 v4.6 found the new architecture correctly written but legacy prose from v2.5 and v2.6 still contradicting it, and no task executing the retirement gate the chapter defines. Consistency correction only - no new architecture, no phase redesign, no task reopened.

---

## 0. WHAT v2.9.1 CHANGES, AND WHY
...
|---|---:|---|
| M1 baseline scope | 574 | every task in M1, complete or not |
...
| Remaining estimate | 482 | scope minus completed |
