...
**This section describes a transitional exception, not the target architecture.** Section 4.5.2 above remains the authority for what this product is. Everything here expires at the start of M2 Release 1, and the expiry is a dated, gated event rather than an intention.
...
**CONVERGENCE POINT** is the start of M2 Release 1, where the frozen Fleet v2 generator emits the native customer-source fixtures and the full external path resumes as the only authority.
...
5. **M2 Release 1 restores and certifies the full external-source pipeline.** No part of the exception survives into M2 Release 1 unproven.
