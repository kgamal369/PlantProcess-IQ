  ...
  return (
    <header className="app-command-header">
      ...
      <div className="app-command-header__right">
        ...
        <StandardButton className="app-command-header__icon-button" type="button" aria-label="Notifications">
          <Bell size={17} aria-hidden="true" />
          <span className="app-command-header__notification-dot" aria-hidden="true" />
        </StandardButton>

        <StandardButton className="app-command-header__user" type="button" aria-label="User menu">
