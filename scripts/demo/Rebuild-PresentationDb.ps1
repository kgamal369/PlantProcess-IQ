...
if (-not $dashOk) {
    ...
    $rows = @(
        ...
        (WRow '21000000-0000-0000-0000-000000000108' $D[0] 'PO_TABLE' 'Volume by Grade' 'table' 'gradeOrRecipe' 'materialCount' 'NULL' $L.BR 8),
        (WRow '21000000-0000-0000-0000-000000000201' $D[1] 'QM_TREND' 'Defect Rate Trend' 'line' 'day' 'defectRate' 'NULL' $L.MAIN 1),
        (WRow '21000000-0000-0000-0000-000000000202' $D[1] 'QM_BREAK' 'Defects by Grade' 'bar' 'gradeOrRecipe' 'defectCount' 'NULL' $L.SIDE 2),
        (WRow '21000000-0000-0000-0000-000000000203' $D[1] 'QM_SEV' 'Quality Events by Type' 'bar' 'defectType' 'defectCount' 'NULL' $L.BL 3),
        (WRow '21000000-0000-0000-0000-000000000204' $D[1] 'QM_TABLE' 'Defects by Grade' 'table' 'gradeOrRecipe' 'defectCount' 'NULL' $L.BR 4),
