  ...
  return (
    <div className="new-landing-wrapper">
        ...
        <div className="wrap">
          <div>
            ...
            <p className="lead rv" style={{ transitionDelay: ".12s" }}>
              PlantProcess IQ connects to the systems you already run â€” Level&nbsp;2, SAP, sensors, quality, lab, inspection, even Excel â€” reads their data, and turns it into answers: what caused this defect, where the downtime really comes from, what to adjust next shift.
            </p>
          ...
          <div className="hub rv" style={{ transitionDelay: ".2s" }} role="img" aria-label="PlantProcess IQ at the center of the plant">
            <svg viewBox="0 0 560 520" width="100%" aria-hidden="true">
              ...
              <g><rect className="srcbox" x="22" y="56" width="120" height="42" rx="7"/><text className="srct" x="82" y="74" textAnchor="middle">Level 2 Â· L2 DB</text><text className="srcs" x="82" y="89" textAnchor="middle">process automation</text></g>
              <g><rect className="srcbox" x="220" y="14" width="120" height="42" rx="7"/><text className="srct" x="280" y="32" textAnchor="middle">SAP / ERP</text><text className="srcs" x="280" y="47" textAnchor="middle">orders Â· materials</text></g>
              <g><rect className="srcbox" x="418" y="56" width="120" height="42" rx="7"/><text className="srct" x="478" y="74" textAnchor="middle">L1 Sensors</text><text className="srcs" x="478" y="89" textAnchor="middle">historian Â· telemetry</text></g>
              ...
              <g><rect className="srcbox" x="404" y="398" width="120" height="42" rx="7"/><text className="srct" x="464" y="416" textAnchor="middle">Files</text><text className="srcs" x="464" y="431" textAnchor="middle">Excel Â· CSV exports</text></g>
              ...
              <text className="outt" x="280" y="496" textAnchor="middle">Predictions Â· AI+ML</text>
      ...
      <div className="band rv">
        <div className="wrap">
          <div className="cell"><div className="big">Quality <span>â†‘</span></div><div className="s">Trace every recurring defect to its process cause across the whole production journey â€” and remove it at the source.</div></div>
          <div className="cell"><div className="big">Downtime <span>â†“</span></div><div className="s">Separate equipment stops from the production losses they create, and see which ones actually cost you output.</div></div>
          <div className="cell"><div className="big">Productivity <span>â†‘</span></div><div className="s">Yield, energy and throughput explained in one place â€” every 1% of prime yield recovered goes straight to margin.</div></div>
        </div>
      </div>
      ...
      <section className="section" id="platform">
        <div className="wrap">
          ...
          <p className="lead rv" style={{ transitionDelay: ".1s" }}>No rip-and-replace. PlantProcess IQ sits beside your existing systems, reads their data through a secure read-only connection, rebuilds the full material genealogy, and applies statistics and AI â€” so your teams get answers, not another database.</p>
          <div className="flow rv" style={{ transitionDelay: ".15s" }}>
            <div className="fl-row">
              ...
              <div className="fl-node">
                ...
                <div className="h">Analyze</div><div className="s">statistics Â· correlations Â· AI+ML</div>
              </div>
              <div className="fl-arrow"></div>
              <div className="fl-node">
                ...
                <div className="h">Recommend</div><div className="s">suggestions Â· predictions Â· assistant</div>
              </div>
              <div className="fl-arrow"></div>
              <div className="fl-node">
                ...
                <div className="h">Improve</div><div className="s">quality Â· uptime Â· KPIs, shift by shift</div>
              </div>
            </div>
          </div>
          <div className="grid g3">
            <div className="card rv"><span className="pill">Chatbot assistant</span><h3>Ask the plant a question</h3><p>â€œWhich line produced the most defects this week â€” and what changed in the process?â€ Grounded answers with the evidence behind them, in plain language.</p></div>
            <div className="card rv" style={{ transitionDelay: ".08s" }}><span className="pill">Predictions</span><h3>See problems before the shift does</h3><p>AI models trained on your own history flag at-risk material and drifting parameters early â€” while there is still time to act.</p></div>
            <div className="card rv" style={{ transitionDelay: ".16s" }}><span className="pill">Recommendations</span><h3>The next best action, ranked</h3><p>Suggestion cards tell your team what to look at first â€” with the data trail that justifies each recommendation.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="packs">
        <div className="wrap">
          <p className="eyebrow rv">ONE PLATFORM Â· FOUR CAPABILITY PACKS</p>
      ...
      <section className="section" id="nocode">
        <div className="wrap">
          <p className="eyebrow rv">NO-CODE Â· NO CONSULTING ARMY</p>
          <h2 className="rv" style={{ transitionDelay: ".05s" }}>Configured by your engineers â€” not by experts you have to hire</h2>
          <div className="split">
            <div className="rv">
              <p className="lead">Connecting a new data source, mapping its tables, building a dashboard or defining an analysis â€” all of it happens in a visual, no-code interface your own process engineers operate after a short onboarding.</p>
              <ul className="tick">
                <li>Generic, dynamic ETL: point at any table, map it visually, load it on a schedule</li>
                <li>Dashboards and analyses assembled by drag &amp; drop â€” no SQL required, SQL available when wanted</li>
            ...
            <div className="nocode-mock rv" style={{ transitionDelay: ".1s" }} role="img" aria-label="Stylized no-code mapping canvas">
              <svg viewBox="0 0 520 300" width="100%" aria-hidden="true">
                ...
                <g><rect className="ncnode" x="250" y="120" width="110" height="62" rx="8"/><text className="nct" x="305" y="146" textAnchor="middle">MAP &amp; JOIN</text><text className="ncs" x="305" y="162" textAnchor="middle">visual Â· validated</text></g>
      ...
      <section className="section roles" id="roles">
        <div className="wrap">
          ...
          <div className="grid g3">
            ...
            <div className="card rv" style={{ transitionDelay: ".24s" }}><div className="who">CFO &amp; Procurement</div><h3>Fund a measurable plant outcome â€” not another open-ended software programme.</h3></div>
            <div className="card rv" style={{ transitionDelay: ".3s" }}><span className="pill g">Time to value</span><h3 style={{ marginTop: "12px" }}>Weeks to first insight</h3><p>Connect one line, load its history, and review the first findings with your team â€” typically within the first weeks of a pilot.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="deploy">
        <div className="wrap">
          ...
          <div className="grid g3">
            <div className="card rv"><span className="pill">On-premise</span><h3>Your data stays in your plant</h3><p>Containerized deployment on your servers or private cloud â€” nothing leaves your network.</p></div>
            ...
            <div className="card rv" style={{ transitionDelay: ".16s" }}><span className="pill">Evidence-grade</span><h3>Every number can show its source</h3><p>Findings, KPIs and recommendations trace back to the source records they came from â€” the level of rigor your quality and audit teams expect.</p></div>
          </div>
        </div>
      </section>
